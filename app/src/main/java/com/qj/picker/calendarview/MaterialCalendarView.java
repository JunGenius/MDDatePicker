...
import com.qj.picker.R;
import com.qj.picker.format.ArrayWeekDayFormatter;
import com.qj.picker.format.DateFormatFormatter;
import com.qj.picker.format.DayFormatter;
import com.qj.picker.format.MonthArrayTitleFormatter;
import com.qj.picker.format.TitleFormatter;
...
public class MaterialCalendarView extends ViewGroup {
     ...
     */
    public static final int DEFAULT_TILE_SIZE_DP = 40;
    private static final int DEFAULT_DAYS_IN_WEEK = 7;
    private static final int DEFAULT_MAX_WEEKS = 6;
    private static final int DAY_NAMES_ROW = 1;

    private static final TitleFormatter DEFAULT_TITLE_FORMATTER = new DateFormatFormatter();
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.mipmap.mcv_action_previous);
            }
            ...
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.mipmap.mcv_action_next);
            }
